...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/roi/roiWP/css/font-awesome.min.css">
	<!-- CSS3 button styles -->
	<link rel="stylesheet" type="text/css" href="/roi/roiWP/css/bootstrap.min.css" />
	<link rel="stylesheet" type="text/css" href="/roi/roiWP/css/default.css" />
	<link rel="stylesheet" type="text/css" href="/roi/roiWP/css/component.css" />
	
	<!-- CSS3 button js -->
	<script src="/roi/roiWP/js/modernizr.custom.js"></script>
	<script src="/roi/roiWP/js/classie.js"></script>
	<script src="/roi/roiWP/js/bootstrap.min.js"></script>
		...
		<header id="masthead" class="site-header" role="banner">
			<div class="logo-row">
				<a class="home-link fadeIn-5" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					<img src="/roi/roiWP/images/logo.png"/>
